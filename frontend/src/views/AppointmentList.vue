<template>
  <div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">{{ $t('appointment.appointmentSchedule') }}</h1>
        <p class="mt-1 text-sm text-gray-500">{{ $t('appointment.noAppointmentsDesc') }}</p>
      </div>
      <router-link
        to="/appointments/add"
    ...
    >
      <div class="flex flex-col items-center space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-900">{{ $t('appointment.noAppointments') }}</h3>
        <p class="text-gray-500 max-w-sm">{{ $t('appointment.noAppointmentsDesc') }}</p>
        <router-link
          to="/appointments/add"
