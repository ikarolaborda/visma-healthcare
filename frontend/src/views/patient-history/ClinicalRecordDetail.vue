<template>
  <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
          View detailed clinical record information
        </p>
      </div>
    ...
    >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-900">
              {{ formatDateTime(record.effectiveDateTime) }}
            </p>
          </div>
          ...
          <div v-if="record.meta?.lastUpdated">
            ...
            <p class="mt-1 text-gray-900">
              {{ formatDateTime(record.meta.lastUpdated) }}
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- Observation Value -->
      <div
        v-if="record.valueQuantity || record.valueString"
        ...
        <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6">
          <div v-if="record.valueQuantity">
            ...
            <p class="text-4xl font-bold text-primary-900">
              ...
              <span
                v-if="record.valueQuantity.unit"
                class="text-2xl font-medium ml-2"
              >
      ...
      <div
        v-if="record.interpretation || record.bodySite || record.method"
        class="glass rounded-2xl shadow-lg p-6"
      >
        <div class="border-b border-gray-200 pb-3 mb-6">
          <h3 class="text-lg font-semibold text-gray-900 flex items-center">
      ...
      >
        ...
        <div class="space-y-3">
          <div
            v-for="(note, index) in record.note"
            :key="index"
