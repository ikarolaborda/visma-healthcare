<template>
  <div class="space-y-6 animate-fade-in">
    ...
    <div
      v-else-if="error"
      class="glass rounded-2xl shadow-lg p-12 animate-scale-in"
    >
      <div class="flex flex-col items-center space-y-4">
        <svg
          class="h-16 w-16 text-danger-500"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    >
      ...
      <div class="glass rounded-2xl shadow-lg p-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
          <svg
            class="h-6 w-6 mr-3 text-primary-600"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div
        v-if="hasContactInfo"
        class="glass rounded-2xl shadow-lg p-8"
      >
        <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
          <svg
            class="h-6 w-6 mr-3 text-primary-600"
      ...
      <div class="glass rounded-2xl shadow-lg p-8">
        ...
        <!-- No Appointments -->
        <div
          v-else-if="!patientAppointments || patientAppointments.length === 0"
        ...
        >
          ...
          <p class="mt-1 text-sm text-gray-500">
            {{ $t('appointment.noAppointmentsForPatient') }}
          </p>
          <div class="mt-6">
            <router-link
              :to="`/appointments/add?patientId=${patient.id}`"
        ...
        >
          ...
          <!-- View All Link -->
          <div
            v-if="patientAppointments.length > 5"
