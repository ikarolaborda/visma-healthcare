        ...
        <div class="p-6 space-y-6">
          ...
          <div v-if="selectedPrescription.dosage_text">
            ...
            <p class="text-gray-700">
              {{ selectedPrescription.dosage_text }}
            </p>
          </div>
          ...
          <div>
            ...
            <p class="text-gray-700">
              {{ selectedPrescription.prescriber_name }}
            </p>
          </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div v-if="selectedPrescription.authored_on">
                ...
                <p class="text-gray-900">
                  {{ formatDate(selectedPrescription.authored_on) }}
                </p>
              </div>
              <div v-if="selectedPrescription.dosage_period_start">
                ...
                <p class="text-gray-900">
                  {{ formatDate(selectedPrescription.dosage_period_start) }}
                </p>
              </div>
              <div v-if="selectedPrescription.dosage_period_end">
                ...
                <p class="text-gray-900">
                  {{ formatDate(selectedPrescription.dosage_period_end) }}
                </p>
              </div>
            </div>
          </div>
