  ...
  <div class="space-y-6 animate-fade-in">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Clinical records, conditions, and observations</p>
      </div>
      <router-link
    ...
    <div v-if="loading" class="glass rounded-2xl shadow-lg p-12 text-center">
      ...
      <p class="text-gray-500 mt-4">Loading clinical records...</p>
    </div>
    ...
    >
      <div class="flex flex-col items-center space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-900">No Clinical Records Found</h3>
        <p class="text-gray-500 max-w-sm">Start documenting patient medical history</p>
        <router-link
          to="/patient-history/add"
