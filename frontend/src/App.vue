<template>
  <div class="min-h-screen flex flex-col">
    ...
    <nav class="glass-dark sticky top-0 z-50 shadow-lg">
          ...
          <div class="hidden md:block">
            <div class="flex items-center space-x-2">
              <template v-if="isAuthenticated">
                ...
                <div
                  class="relative"
                  @mouseenter="medicalDropdownOpen = true"
                  @mouseleave="medicalDropdownOpen = false"
                >
                  <button
                ...
                <!-- User Dropdown -->
                <div
                  class="relative ml-4 pl-4 border-l border-gray-600"
      ...
      <div
        v-if="mobileMenuOpen"
        class="md:hidden bg-gray-900/50 backdrop-blur-md border-t border-gray-700"
      >
        <div class="px-2 pt-2 pb-3 space-y-1">
          <template v-if="isAuthenticated">
            ...
            <router-link
              ...
              :class="$route.path === '/' ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
            ...
            <router-link
              to="/patients"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/patient') && !$route.path.startsWith('/patient-history') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              {{ $t('nav.patients') }}
            </router-link>
            ...
            <router-link
              to="/appointments"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/appointment') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              {{ $t('nav.appointments') }}
            </router-link>
            <router-link
              to="/prescriptions"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/prescription') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              Prescriptions
            </router-link>
            <router-link
              to="/patient-history"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/patient-history') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              Clinical History
            </router-link>
            ...
            <router-link
              to="/practitioners"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/practitioner') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              {{ $t('nav.practitioners') }}
            </router-link>
            <router-link
              to="/billing"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/billing') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              Billing
            </router-link>
            ...
            <router-link
              to="/reports"
              class="block px-3 py-2 rounded-lg text-base font-medium transition-all"
              :class="$route.path.startsWith('/reports') ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-white/10'"
              @click="mobileMenuOpen = false"
            >
              Reports
            </router-link>
            ...
            <div class="border-t border-gray-700 mt-2 pt-2">
              <router-link
                to="/profile"
                class="block px-3 py-2 rounded-lg text-base font-medium text-gray-300 hover:bg-white/10"
                @click="mobileMenuOpen = false"
              >
                Profile
              </router-link>
