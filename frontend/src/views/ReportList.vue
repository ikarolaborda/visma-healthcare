        ...
        <div class="flex items-start justify-between">
          <div class="flex-1">
            ...
            <p
              ...
              class="text-sm text-red-600 bg-red-50 rounded-lg p-3 mt-3"
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <option
                      v-for="practitioner in activePractitioners"
                      :key="practitioner.id"
